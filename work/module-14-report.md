...
- [x] Verify the current browser session has access to `https://epam.atlassian.net` and the `ARE` project; escalate if access is still restricted. ([#7](https://github.com/RushiD20/jira-confluence-automation/issues/7))
- [x] Identify the parent issue types and sub-task issue type used in `ARE` and confirm which parent issues should be included. ([#5](https://github.com/RushiD20/jira-confluence-automation/issues/5))
...
- [x] Confirm the exact `DONE` transition name for parent issues and the exact reopen transition used when a parent in `DONE` is reopened. ([#3](https://github.com/RushiD20/jira-confluence-automation/issues/3))
- [x] Validate that the automation rule actor can browse issues, add comments, transition issues, and notify users in `ARE`. ([#10](https://github.com/RushiD20/jira-confluence-automation/issues/10))
- [x] Confirm the issue assignee can be mentioned and notified by Jira Automation comments. ([#6](https://github.com/RushiD20/jira-confluence-automation/issues/6))
...
- [x] Create a working list of status values and transition names for the rule builder so the smart values and conditions are mapped correctly during configuration. ([#11](https://github.com/RushiD20/jira-confluence-automation/issues/11))
- [x] Document the rule naming convention and rule ownership, including who will monitor execution logs and manage workflow changes. ([#2](https://github.com/RushiD20/jira-confluence-automation/issues/2))
...
|-----------|-------|-----------------|
| https://github.com/RushiD20/jira-confluence-automation/issues/1 | Confirm Jira access and project permissions for the rule actor in project ARE | Yes |
